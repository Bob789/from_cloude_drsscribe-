...
from app.routers import auth, patients, visits, visits_manual, recordings, transcriptions, summaries, search, tags, websocket, dashboard, admin, reports, health, patient_files, custom_fields, question_templates, appointments
