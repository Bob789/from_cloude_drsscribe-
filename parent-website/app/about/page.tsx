    ...
    <div className="about-page">
      ...
      <div className="about-body">
        ...
        <p style={{ color: '#444', fontSize: 15, lineHeight: 1.85, marginBottom: 36, maxWidth: 720 }}>
          אנחנו רוצים לפתח קהילה בינלאומית שלומדת את תחום הרפואה ומתייעצת,
          ונחשפת למחקרים ופיתוחים חדשים ולטיפולים שקיימים.
        </p>
        ...
        <div className="about-features">
          {[
            { icon: '📚', title: 'מאמרים רפואיים מקצועיים', text: 'מאמרים בנושאי בריאות מגוונים מקרדיולוגיה ועד תזונה שנכתבים במספר שפות ונסמכים על מקורות רפואיים עדכניים.' },
            { icon: '🔍', title: 'חיפוש חכם ומדויק', text: 'מנוע חיפוש שמבין מונחים רפואיים ומוביל ישירות לתוכן הרלוונטי בלי לשוטט.' },
            ...
            { icon: '🔒', title: 'פרטיות ושקיפות', text: 'אנחנו לא מוכרים נתונים אישיים, המידע כאן בשבילכם.' },
          ].map(f => (
        ...
        <div className="about-values">
          {[
            ...
            { icon: '❤️', title: 'אמפתיה דיגיטלית', text: 'מי שמחפש מידע רפואי לרוב חושש או חרד. אנחנו מקפידים על טון רגיש, שפה נקייה ותוכן שמרגיע ולא מפחיד.' },
          ].map(v => (
