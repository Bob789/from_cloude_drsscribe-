            ...
            {related.length > 0 && (
             ...
             <div style={{ padding: '0 24px 24px 24px' }}>
                <div className="legal-notice">
                  <div className="legal-notice-title">תוכן האתר אינו מהווה ייעוץ רפואי</div>
                  <p>המידע המופיע באתר זה, לרבות כתבות, סקירות, ניתוחים, נתונים וכל תוכן אחר, מיועד למטרות כלליות, אינפורמטיביות ולימודיות בלבד, ואין לראות בו המלצה, חוות דעת, ייעוץ או תחליף לייעוץ רפואי אישי ו/או אבחון רפואי המותאם לצרכים הספציפיים של אדם מסוים. המידע אינו מהווה הצעה לבצע טיפול, לרכוש תרופות, תוספי מזון, ציוד רפואי או כל שירות בריאותי אחר. כל אדם המעוניין לקבל החלטות הנוגעות לבריאותו, חייב לבחון את המידע באופן עצמאי, תוך התחשבות במצבו הבריאותי, צרכיו האישיים ורמת הסיכון המתאימה לו.</p>
                  <p>השימוש במידע שפורסם באתר הוא על אחריות המשתמש בלבד. המערכת והחברה המפעילה אינם אחראים לכל נזק בריאותי, גופני, נפשי או אחר שייגרם, במישרין או בעקיפין, כתוצאה משימוש במידע, הסתמכות עליו או ביצוע פעולה כלשהי בהסתמך עליו. לפני קבלת כל החלטה רפואית, יש להתייעץ עם רופא מוסמך ובעל רישיון מתאים.</p>
                </div>
            </div>
