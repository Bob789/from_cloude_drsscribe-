            ...
            child: SingleChildScrollView(
              child: Padding(
                ...
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text('search.title'.tr(), style: GoogleFonts.heebo(fontSize: isNarrow ? 20 : 26, fontWeight: FontWeight.w800, color: AppColors.textPrimary)),
                    const SizedBox(height: 4),
                    Text('search.subtitle'.tr(), style: GoogleFonts.heebo(fontSize: isNarrow ? 12 : 14, color: AppColors.textMuted)),
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          if (tagsState.isLoading)
                            ...
                            ConstrainedBox(
                              constraints: BoxConstraints(maxHeight: isNarrow ? 80 : 120),
                              child: SingleChildScrollView(
                                child: Wrap(
                                  spacing: 6,
                                  runSpacing: 6,
                                        ...
                                        child: Container(
                                          ...
                                          child: Row(
                                            ...
                                            children: [
                                              ...
                                              Flexible(child: Text(label, style: GoogleFonts.heebo(fontSize: 12, fontWeight: FontWeight.w500, color: isSelected ? AppColors.primary : AppColors.textSecondary), overflow: TextOverflow.ellipsis)),
                                              const SizedBox(width: 4),
            ...
            child: !hasInput
                ? Center(
                    child: Column(
                      ...
                      children: [
                        Icon(Icons.search_rounded, size: isNarrow ? 40 : 56, color: AppColors.textMuted.withValues(alpha: 0.3)),
                        const SizedBox(height: 16),
                        Text('search.empty_hint'.tr(), style: GoogleFonts.heebo(fontSize: isNarrow ? 14 : 16, fontWeight: FontWeight.w600, color: AppColors.textSecondary)),
                        const SizedBox(height: 6),
                        Padding(
                          padding: EdgeInsets.symmetric(horizontal: hPad),
                          child: Text('search.empty_subtitle'.tr(), style: GoogleFonts.heebo(fontSize: 13, color: AppColors.textMuted), textAlign: TextAlign.center),
                        ),
                      ],
                    ),
                  )
